...
public class lightLocalizer extends Thread {
	...
	private final double SENSOR_OFFSET = 5.0; // distance between center of the
												// track and light sensor
	...
	// constructor
	public lightLocalizer(Odometer odo, EV3LargeRegulatedMotor leftMotor, EV3LargeRegulatedMotor rightMotor,
			SampleProvider RColor, SampleProvider LColor, float[] RData, float[] LData) {
	...
	/**
	 * this method travels forward to square up with the line infront, it then
	 * calls correctX to square up with the line 90 degrees to the right
	 * 
	 * this method should only be called when the robot is facing clockwise in
	 * one of the corners
	 * 
	 * @param startCorner
	 *            allows this method to correctly set the coordinates in the
	 *            odometer
	 */
	...
	/**
	 * this method is called by correctXY, it squares up with the line that is
	 * 90degress to the robots right
	 * 
	 * @param startCorner
	 *            allows the robot to correct the odometer coordinates for each
	 *            corner
	 */
	...
	public void travelTo(double x, double y) {
		...
		Theta = (Math.atan2(dX, dY)) * 180 / Math.PI; // convert from radius to
														// degree
